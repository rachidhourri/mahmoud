    ...
    <section id="subheader" data-speed="8" data-type="background" class="padding-top-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>
                      <?php echo htmlspecialchars_decode( do_shortcode( $archi_option['404_title'] ) ); ?> 
                    </h1>
...
<div id="content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
               <h1 class="title_404"><?php echo htmlspecialchars_decode( do_shortcode( $archi_option['404_title'] ) ); ?></h1>
				<div class="content_404 center">
					<?php echo htmlspecialchars_decode( do_shortcode( $archi_option['404_content'] ) ); ?>
				</div>
