                ...
                <div class="container">
                    <div class="row">
                           <div class="col-md-6 col-md-offset-3">
                            <h2><?php echo htmlspecialchars_decode( do_shortcode( $archi_option['hc_title'] ) ); ?></h2>
                            <?php echo htmlspecialchars_decode( do_shortcode( $archi_option['hc_stitle'] ) ); ?>                   
            ...
            <section id="section-coming-soon" class="coming-soon padding-top-90">
                <div class="coming-soon-content text-center">
                    ...
                    <div class="teaser-text">
                        <h2><?php echo htmlspecialchars_decode( do_shortcode( $archi_option['cs_title'] ) ); ?></h2>
                        <br>
                        <?php echo htmlspecialchars_decode( do_shortcode( $archi_option['cs_stitle'] ) ); ?>
                    </div>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <ul class="countdown">
                          <li> 
                            ...
                            <p class="days_ref"><?php _e('days', 'archi');  ?></p>
                          </li>
                          <li class="seperator">.</li>
                          <li>
                            <span class="hours">00</span>
                            <p class="hours_ref"><?php _e('hours', 'archi');  ?></p>
                          </li>
                          <li class="seperator">:</li>
                          <li> 
                            <span class="minutes">00</span>
                            <p class="minutes_ref"><?php _e('minutes', 'archi');  ?></p>
                          </li>
                          <li class="seperator">:</li>
                          <li>
                            <span class="seconds">00</span>
                            <p class="seconds_ref"><?php _e('seconds', 'archi');  ?></p>
                          </li>
                        </ul>
                    </div>
                    <div class="col-md-8 col-md-offset-2">
            ...
            <section class="section-fixed no-top no-bottom">
                <div class="de-video-overlay dotted"></div>
                    ...
                    <video autoplay="" loop="" muted="">
                        <source src="<?php echo esc_url($archi_option['link_video_mp4']); ?>" type="video/mp4" />
                        <source src="<?php echo esc_url($archi_option['link_video_webm']); ?>" type="video/webm" />
                    </video>
            </section>
	...
	(function ($) {
		...
		$.fn.downCount = function (options, callback) {
			...
			function countdown () {
				...
				var ref_days = (days === 1) ? 'day' : '<?php _e('days', 'archi');  ?>',
					ref_hours = (hours === 1) ? 'hour' : '<?php _e('hours', 'archi');  ?>',
					ref_minutes = (minutes === 1) ? 'minute' : '<?php _e('minutes', 'archi');  ?>',
					ref_seconds = (seconds === 1) ? 'second' : '<?php _e('seconds', 'archi');  ?>';
