          ...
          <div class="<?php if(isset($archi_option['blog-layout']) and $archi_option['blog-layout'] != 1 ){echo 'col-md-8';}else{echo 'col-md-12';}?>">
            <?php if ( have_posts() ) : ?>
                ...
                <ul class="blog-list">
                  <li class="single">                  
                    ...
                    <div class="post-info">
                      ...
                      <span><i class="fa fa-user"></i><?php _e('By : ','archi') ?><?php the_author_posts_link(); ?></span> 
                      ...
                      <?php if ( comments_open() ) : ?>
                        <span><i class="fa fa-comment"></i><span class="comments_number"><?php comments_number( __('0 comment', 'archi'), __('1 comment', 'archi'), __('% comments', 'archi') ); ?></span></span> 
                      <?php  endif; ?> 
              ...
              <div class="post-controls clearfix">
                <?php 
                  if ($archi_option['post_navigation'] == 'samecategory') {
                    ...
                    previous_post_link( '%link', '<span class="post-title"><em>' . __( 'Older Post', 'archi' ) . '</em><strong>%title</strong></span>', true );
                    next_post_link( '%link', '<span class="post-title"><em>' . __( 'Newer Post', 'archi' ) . '</em><strong>%title</strong></span>', true );
                  }else{
                    // Previous/next post navigation.
                    the_post_navigation( array(
                      'prev_text' => '<span class="post-title"><em>' . __( 'Older Post', 'archi' ) . '</em><strong>%title</strong></span>',
                      'next_text' => '<span class="post-title"><em>' . __( 'Newer Post', 'archi' ) . '</em><strong>%title</strong></span>',                    
                    ) ); 
                  }
                ?>
              </div>
              ...
              <?php if ( comments_open() || get_comments_number() ) : ?>
                <div class='comments-box'><h4><?php comments_number( __('0 comment', 'archi'), __('1 comment', 'archi'), __('% comments', 'archi') ); ?><h4></div>
