...
if(function_exists('vc_map')){
   ...
   "params"    => array( 
      ...
      array(
         ...
         "value" => "",
         "description" => __("Ex: <code>coffee</code>, <a href='http://fontawesome.io/icons/' target='_blank'>Find library Font-Awesome icons</a>", 'archi'),
      ...
      array(
         ...
         'params' => array(
            array(
               ...
               "value" => "",
               "description" => __("Add social icon class name, eg: facebook, find more: http://fontawesome.io/icons/", 'archi')
            ),  
            array(
               'type' => 'textfield',
               "holder" => "div",
...
function select_param_testimonials( $settings, $value ) {
  ...
  return sprintf(
     '<input type="hidden" name="%s" value="%s" class="wpb-input-category_testimonials wpb_vc_param_value wpb-textinput %s %s_field" %s>
...
if(function_exists('vc_map')){   
   vc_map( array(
   "name" => __("OT Blog Post Silder", 'archi'),
   "base" => "latestblog",
   "class" => "",
   "category" => 'Archi Elements',
   "icon" => "icon-st",
