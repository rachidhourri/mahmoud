							...
							<?php if ($archi_option['project_sharing']!=false) { ?>
								<div class="socials-portfolio socials-rounded">
									...
									<div class="socials-sharing"> 
										...
										<a class="socials-item" target="_blank" href="http://www.tumblr.com/share/link?url=<?php the_permalink(); ?>&name=<?php the_title(); ?>&description=<?php the_excerpt(); ?>" title="Tumblr"><i class="fa fa-tumblr"></i></a> 
