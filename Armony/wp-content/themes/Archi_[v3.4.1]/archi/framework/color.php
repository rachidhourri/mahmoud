    ...
    <style type="text/css">    	
		...
		<?php if ($archi_option['dropdown-menu-customize']==true) { ?>
			@media only screen and (min-width: 992px) {
				#mainmenu li ul{width: <?php echo esc_attr($archi_option['dropdown-menu-width']); ?>px;}
				#mainmenu li li, #mainmenu li li li {border-bottom-color: <?php echo esc_attr( $archi_option['dropdown-border-color'] ); ?>;}
				#mainmenu li li a, #mainmenu li li li a{background-color:<?php echo esc_attr( $archi_option['dropdown-bgcolor'] ); ?>;color:<?php echo esc_attr( $archi_option['dropdown-text-color'] ); ?>;}			
			}
		<?php } ?>	
		...
		#mainmenu > li > a:hover, #mainmenu > li.current-menu-item > a, header.smaller #mainmenu > li > a:hover, header.smaller #mainmenu > li.current-menu-item > a {
			color: <?php echo esc_attr( $archi_option['main-color'] ); ?>;opacity:1;
		}
		#mainmenu li.current-menu-ancestor li.current-menu-ancestor > a, #mainmenu li li.active > a,
		header.smaller #mainmenu li li a:hover, #mainmenu li li a:hover {
			background-color:<?php echo esc_attr( $archi_option['main-color'] ); ?>;color:#111;
		}
